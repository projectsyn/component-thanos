...
Each instance of this component should have its own namespace.
The default value takes the instance name and ensures that each instance is installed in its own namespace.
...
Multiple instances should't share the same dashboard namespace to avoid name collisions.
